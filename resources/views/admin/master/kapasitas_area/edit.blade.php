...
@section('content')
        <h1>Sunting Kapasitas Area</h1>

        <a href="{{ route('admin.master.kapasitas_area.index') }}">Kembali</a>
        <form action="{{ route('admin.master.kapasitas_area.update', $kapasitasArea) }}" method="POST">
            @csrf
            @method('PUT')
