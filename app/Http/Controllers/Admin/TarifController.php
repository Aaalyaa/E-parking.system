...
class TarifController extends Controller
{
    public function index()
    {
        ...
        return view('admin.master.tarif.index', compact('tarifs'));
    }

    public function create()
    {
        $tipeKendaraans = TipeKendaraan::all();
        return view('admin.master.tarif.create', compact('tipeKendaraans'));
    }
    ...
    {
        $tipeKendaraans = TipeKendaraan::all();
        return view('admin.master.tarif.edit', compact('tarif', 'tipeKendaraans'));
    }
